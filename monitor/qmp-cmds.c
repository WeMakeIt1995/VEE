...
#include "hw/vee/vee-qapi-commands.h"
#include "hw/vee/vee-qapi-init-commands.h"
...
static void __attribute__((__constructor__)) monitor_init_qmp_commands(void)
{
    ...
    qmp_register_command(&qmp_commands, "vee-command",
                         qmp_marshal_vee_command, 0, 0);
    qmp_register_command(&qmp_commands, "vee-ssd1306-get-pixel",
                         qmp_marshal_vee_ssd1306_get_pixel, 0, 0);
    qmp_register_command(&qmp_commands, "vee-vm-feed",
                         qmp_marshal_vee_vm_feed, 0, 0);
    qmp_register_command(&qmp_commands, "vee-get-vm-time-us",
